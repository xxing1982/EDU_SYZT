...
ctrls.controller("readingCenterAddBookPopularRecommendController", ['$rootScope','$scope','$stateParams','Pageable', 'ConditionSearch','JoinShelf'
        ,'WeeklyRecommendSearch','MonthlyRecommendSearch','YearlyRecommendSearch','config','Dictionary',function ($rootScope,$scope,$stateParams,Pageable,ConditionSearch,JoinShelf,WeeklyRecommendSearch,MonthlyRecommendSearch,YearlyRecommendSearch,config,Dictionary) {
