/**
 * Created by by on 2015/7/31.
 */
//statisticsSummary.js

ctrls.controller("othersStatController", ['$scope' , '$stateParams', '$resource', 'config', 'Student', 'Semester', 'Campus', 'Class', 'BookshelfStatistics', 'Note', 'PointHistory', 'CoinHistory', 'TaskStatistics',
    function ($scope, $stateParams, $resource, config, Student, Semester, Campus, Class, BookshelfStatistics, Note, PointHistory, CoinHistory, TaskStatistics) {
        ...
        $scope.student = Student.get({id: args.id}, function(){
            ...
            $scope.semesters = Semester.get({by: 'student', id: args.id}, function(){
                ...
                $scope.semesters.updateStatistics = function(){
                    ...
                    // Update notes list
                    Note.query({ by: 'semesters', id: semester.id, userId: args.id }, function(notes){
