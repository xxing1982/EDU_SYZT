...
ctrls.controller("othersExamController", ['$scope', '$stateParams', 'VerifyExam', 'WordExam', 'ThinkExam', 'AddReview', 'config',
    function ($scope, $stateParams, VerifyExam, WordExam, ThinkExam, AddReview, config) {
        $scope.content = "";
        $scope.title = "";
        $scope.rate = 0;
        ...
        //source
        VerifyExam.getAllInfo(args.id, function(data){
        ...
        WordExam.getAllInfo(args.id, function(data){
        ...
        ThinkExam.getAllInfo(args.id, function(data){
