//othersBookshelfCtrl.js

ctrls.controller("othersBookshelfController", ['$rootScope', '$scope','$stateParams','BookshelfView',
    'Bookshelf','BookInShelf','DropBookFromShelf', 'NoteTake', 'BookDetail', 'Dropzone', 'config','JoinShelf', function($rootScope, $scope,$stateParams,BookshelfView,Bookshelf,BookInShelf,DropBookFromShelf,NoteTake, BookDetail, Dropzone, config,JoinShelf) {
    ...
    $scope.arguments = {id: $stateParams.studentId};
    ...
    // var bookInShelf = BookInShelf.get({id:$stateParams.studentId,page:0,size:size},function(){
    ...
    $scope.selectBookAttributes = function(val){
        ...
        // $scope.bookInShelf = BookInShelf.get({id:$stateParams.studentId,page:0,size:size},function(){
        var bookshelf = Bookshelf.get({id:$stateParams.studentId},function(){
