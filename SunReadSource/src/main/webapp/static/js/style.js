...
function SetReadingCenterRightHeight(){
	$("#readingCenter-bookshelf").css('min-height' ,document.documentElement.clientHeight - 100);
	$(window).resize(function(){
		$("#readingCenter-bookshelf").css('min-height' ,document.documentElement.clientHeight - 100);
	});
}

//reading denter -> my bookshelf -> book list
function SetBookList(){
	$(".bookshelf-tab").eq(0).addClass("myActive");
